    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* CreateLogin Body | Dont have account? Register */}
          <Box
            sx={{
              display: "flex",
              flexDirection: "row",
          ...
          >
            ...
            <Typography
              ...
              variant="BodyMedium"
              sx={{
                color: theme.custom.color.neutral.DarkBlue,
                textDecoration: "none",
                "&:hover": {
...
export default BodyLoginSection;
